...
export interface IDataPointStorageInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "dataPointSize",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "readDataPoint",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "writeDataPoint",
    values: [BytesLike]
  ): string;
...
export interface IDataPointStorage extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "dataPointSize"
  ): TypedContractMethod<[_dataPointAddress: BytesLike], [bigint], "view">;
  getFunction(
    nameOrSignature: "readDataPoint"
  ): TypedContractMethod<[_dataPointAddress: BytesLike], [string], "view">;
  getFunction(
    nameOrSignature: "writeDataPoint"
